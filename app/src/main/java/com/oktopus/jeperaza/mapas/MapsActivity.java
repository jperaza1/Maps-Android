...
import com.oktopus.jeperaza.mapas.Controler.ctrCoordenadas;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public void onLocationChanged(Location location) {
        ...
        String Latitud,Longuitud;
        Latitud =  String.valueOf(mCurrentLocation.getLatitude());
        Longuitud = String.valueOf(mCurrentLocation.getLongitude());
        //Esta es una Clase donde se guardan los datos que llevan las coordenadas y creo un objeto de ellas
        ctrCoordenadas coordenadas = new ctrCoordenadas(123456,Latitud,Longuitud);
        try{
            //se Convierte el Objeto a formato json
            ObjectMapper mapper = new ObjectMapper();
            String json = mapper.writeValueAsString(coordenadas);
            //Esto manda a llamar la funcion del Post donde se ponen la Url y el Json
            new AsyncTaskPost("http://192.168.1.134:3000/api/Coordenadas",json).execute();
        }catch (Exception ex){
